...
import {csignUp } from "../../services/operation/authApi";
...
export default function Signup() {
  ...
  const handleOnSubmit = (e) => {
    ...
    dispatch(
      csignUp(email,password,navigate)
    )
    ...
    return (
      <div className='w-full flex'>
        <div className='lg:w-[45%] md:[40%] w-[90%] m-auto lg:m-0 h-full flex flex-col justify-center items-center'>
          <h1 className='font-medium text-[35px] mt-[110px] mb-10 w-[80%]'>Join world's largest Creator Community</h1>
         ...
         <Link to='/clogin'><div className='mt-5 underline'>Have an account?</div></Link> 
